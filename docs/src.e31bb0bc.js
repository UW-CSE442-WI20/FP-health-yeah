...
var d3 = require('d3'); // Prevalence of mental health disorders by disorder type


var csvFile = require('../total-data.csv'); // You can load JSON files directly via require.
...
window.disorder_type = disorder.value; // returns a Promise of filtered csv array from all_data
...
window.filter_data_year = filter_data_year; // var counterPie = 1;
...
},{"d3":"../node_modules/d3/index.js","../total-data.csv":"../total-data.csv"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
