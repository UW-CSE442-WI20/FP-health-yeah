...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"map.js":[function(require,module,exports) {
"use strict";
...
function getColor(d) {
  return d == undefined ? 'white' : d > 17 ? '#800318' : d > 15 ? '#950909' : d > 13 ? '#AA2810' : d > 11 ? '#BF4C19' : d > 9 ? '#D57323' : d > 7 ? '#EA9B2F' : d > 5 ? '#FFC33C' : d > 3 ? '#FFB943' : d > 2 ? '#FFED62' : d > 1 ? '#FFF870' : d > 0.5 ? '#FFFF7F' : d > 0.4 ? '#FFFFA0' : d > 0.3 ? '#FFFFB2' : d > 0.2 ? '#FFFFC4' : '#FFFFD8';
}
...
function updateCountry2total() {
  return _updateCountry2total.apply(this, arguments);
}

function _updateCountry2total() {
  _updateCountry2total = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return filter_data_year(window.all_data, window.sliderYear).then(function (d) {
              d.map(function (row) {
